# Vite starter - HTML | Sass | Vanilla JS

This is a Vite starter for vanilla JS projects with Sass. It is entented to be used together with `degit` to speed up the workflow of starting a new project from scratch.
